...
$sql = "SELECT * from typeproduct where ID = $id";
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!is_null($TypeName)) {
        $sql = "UPDATE typeproduct set TypeName = '$TypeName' where  ID = '$id' ";
        $query = mysqli_query($mysqli, $sql);
...
<body id="page-top">
    ...
    <section class="content px-6 py-6 flex flex-col gap-3 bg-white" style="">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <?php
                        echo"<input type=\"text\" disabled value=". $result1["ID"] ." name=\"TypeID\" class=\"form-control\" style=\"width: 200px;\" id=\"inputPassword\" placeholder=\"Nhập ID\">"
                        ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <?php
                        echo"<input type=\"text\"  value=". $result1["TypeName"] ." name=\"TypeName\" class=\"form-control\" style=\"width: 200px;\" id=\"inputPassword\" placeholder=\"Nhập tên danh mục\">"
                        ?>
                    </div> 
                </div>
                <div>
