<?php   
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $ID = isset($_POST["IDSlide"]) ? intval($_POST["IDSlide"]) : null;
        ...
        if(!is_null($ID) && is_numeric($ID)){
            ...
            if (!$matchFound) {
                ...
                $stmt = $mysqli->prepare("INSERT INTO slide (ID, SlideName,sales,Image) 
                                          VALUES (?, ?, ?, ?)");
                $stmt->bind_param("isis", $ID, $Name, $sales, $hinhanh1);
...
<body id="page-top">
    ...
    <section class="content px-6 py-6 flex flex-col gap-3 bg-white" style="">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" name="IDSlide" class="form-control" style="width: 200px;" id="inputPassword" placeholder="Nhập ID slide">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label text-center">SlideName</label>
                    <div class="col-sm-10">
                    <input type="text" name="NameSlide" class="form-control" style="width: 200px;" id="inputPassword" placeholder="Nhập tên slide">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label text-center">Sales</label>
                    <div class="col-sm-10">
                    <input type="text" name="Sales" class="form-control" style="width: 200px;" id="inputPassword" placeholder="Nhập sales">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="w-full" type="file" name="hinhanh">
                    </div> 
                </div>
