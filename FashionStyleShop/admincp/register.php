                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Nhập lại mật khẩu" oninput="checkPasswordMatch()">
                                    </div>
                                    <p id="passwordError" style="color: red; display: none;">Mật khẩu không khớp. Vui lòng nhập lại.</p>
                                </div>
